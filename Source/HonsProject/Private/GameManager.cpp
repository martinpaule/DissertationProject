...
void AGameManager::BeginPlay()
{
	...
	//init game variables
	APawn* Pawn = Cast<APawn>(UGameplayStatics::GetActorOfClass(GetWorld(), APawn::StaticClass()));
	if (Pawn)
	{
		// Return the first pawn found
		playerRef = Pawn;
	}
	...
	startSpawning(500, simulationRadius, SpawnMaxSpeed, SpawnMaxMass);
}
